...
public:
    void addStudent(const string& id, const string& name, const string& date, const string& fname, const string& level);
    void updateStudentRecord(const string& id, const string& newName, const string& newDOA, const string& newFather, const string& level);
